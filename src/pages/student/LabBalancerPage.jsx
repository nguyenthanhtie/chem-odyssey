        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl font-black text-viet-text italic tracking-tighter uppercase">
              Cân bằng <span className="text-viet-green">Phương trình</span>
            </h1>
          </motion.div>
          ...
          >
            ...
            <div>
              <p className="text-xs font-black text-viet-text-light uppercase tracking-widest">Kỹ năng</p>
              <p className="text-base font-black text-viet-text">Số liệu & Định luật</p>
            </div>
          </motion.div>
        </header>
...
export default LabBalancerPage;
