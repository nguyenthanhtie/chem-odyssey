export const bai10 = {
  ...
  "theoryModules": [
    {
      ...
      "type": "heading",
      "content": {
        "text": "1. Khái niệm Hóa học hữu cơ",
        "level": "h2"
      }
    },
    {
    ...
    },
    {
      ...
      "type": "heading",
      "content": {
        "text": "2. Đặc điểm chung của Hợp chất hữu cơ",
        "level": "h2"
      }
    },
    {
  ...
  "quizzes": [
    {
      "id": "q1",
      "question": "Hợp chất nào sau đây KHÔNG phải là hợp chất hữu cơ?",
      "options": [
        "CH4",
        "CO2",
        "C2H5OH",
      ...
      "correctAnswer": 1,
      "explanation": "CO2 (Carbon dioxide) thuộc ngoại lệ, là một hợp chất vô cơ."
    },
    {
      "id": "q2",
      "question": "Đặc điểm chung của các hợp chất hữu cơ là:",
      "options": [
        "Nhiệt độ sôi cao do liên kết ion.",
        "Liên kết chủ yếu là cộng hóa trị.",
        "Tốc độ phản ứng xảy ra cực kỳ nhanh.",
